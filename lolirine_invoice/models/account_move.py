...
class AccountMove(models.Model):
    ...
    def _send_invoice_auto(self):
        ...
        try:
            ...
            invoice_name = self.name or 'Brouillon'
...
<div style="font-family: Arial, sans-serif; font-size: 13px; color: #333;">
    ...
    <div style="margin-top: 25px; padding-top: 15px; border-top: 1px solid #dee2e6;">
        <p style="margin: 0;">
            ...
            <span style="color: #6c757d;">Email : gardemeublelolirine@gmail.com</span>
        </p>
    </div>
</div>
""" % partner_name
...
class SaleSubscription(models.Model):
    ...
    def _send_welcome_email(self):
        ...
        if not self.partner_id.email:
            self.message_post(
                body=_("Envoi email de bienvenue impossible : le client n'a pas d'adresse email."),
                message_type='notification'
            )
            return False
...
<div style="font-family: Arial, sans-serif; font-size: 14px; color: #333; line-height: 1.6;">
    ...
    <ul>
        <li><strong>Date de debut :</strong> %s</li>
    ...
    <p style="margin: 20px 0;">
        <a href="%s" style="background-color: #875a7b; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
...
""" % (partner_name, box_name, start_date_str, portal_url)
            
            mail_values = {
                'subject': "Bienvenue ! Votre acces au box %s" % box_name,
                'body_html': body_html,
            ...
            self.message_post(
                body=_("Email de bienvenue envoye a %s") % self.partner_id.email,
                message_type='notification'
            )
            return True
            
        except Exception as e:
            _logger.error("Erreur envoi email bienvenue %s: %s", self.name, str(e))
            self.message_post(
