...
class WebsitePromotions(http.Controller):
    ...
    def _get_promo_products(self, limit=12):
        ...
        A product is considered 'on promo' if it has a compare_at_price (lst_price)
        greater than its actual selling price, or if a pricelist gives a discount.
        """
        ...
        for product in all_products:
            # Check if product has a compare_at_price set (crossed out price)
