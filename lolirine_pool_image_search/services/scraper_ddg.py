...
class ScraperDuckDuckGo(ScraperBase):
    ...
    # Domaines à interroger en priorité (par ordre)
    TARGET_DOMAINS = [
        # Fournisseurs principaux
        'fluidra.com', 'fluidrapro.com',
        'scpeurope.com', 'scppool.com',
        # Marques majeures
        'pentair.com', 'pentairpooleurope.com',
        'hayward.com', 'hayward-pool.eu',
        'zodiac-poolcare.com', 'zodiac.com',
        'astralpool.com', 'astralpoolfrance.fr',
        'bwt-pool.com', 'bwt.com',
        'cccatalogo.com',
        # Distributeurs secondaires
        'piscine-clic.com', 'mypiscine.com', 'piscineco.fr',
    ]
