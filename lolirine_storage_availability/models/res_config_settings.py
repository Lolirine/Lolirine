...
class ResConfigSettings(models.TransientModel):
    ...
    storage_appointment_button_text = fields.Char(
        string="Texte du bouton (disponible)",
        config_parameter='lolirine_storage.appointment_button_text',
        default="Contactez-nous",
        help="Texte affiché sur le bouton de rendez-vous pour les box disponibles"
    )
    ...
    # Configuration du bouton "Demande générale" (box non disponible)
    storage_general_inquiry_url = fields.Char(
        string="URL page contact",
        config_parameter='lolirine_storage.general_inquiry_url',
        default="/contactus",
        help="URL de la page de contact pour les demandes générales (ex: /contactus, /contact)"
    )

    storage_general_inquiry_button_text = fields.Char(
        string="Texte du bouton (non disponible)",
        config_parameter='lolirine_storage.general_inquiry_button_text',
        default="Demande générale",
        help="Texte affiché sur le bouton pour les box non disponibles"
    )
    ...
    def get_values(self):
        ...
        if appointment_type_id:
            try:
                ...
                res['storage_default_appointment_type_id'] = False
