# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Gestion automatisée des commandes dropshipping avec optimisation des marges',
    'description': """
...
- Calculer automatiquement la marge optimale par fournisseur
- Sélectionner le meilleur fournisseur selon des critères configurables
- Générer automatiquement les commandes fournisseur en dropshipping
...
* Workflow automatisé commande client → commande fournisseur
