# -*- coding: utf-8 -*-
"""
Pool Variant Images – Version minimale sûre
Ajoute un champ image sur les PTAV pour le switch visuel par variante.
"""
...
class ProductTemplateAttributeValueImage(models.Model):
    ...
    variant_image = fields.Image(
        ...
        help="Image affichée quand cette valeur est sélectionnée"
    )
...
class ProductTemplateVariantImages(models.Model):
    ...
    def _auto_assign_variant_images(self):
        ...
        # Stratégie 1 : nom image contient nom valeur
        ...
        # Stratégie 2 : image_variant_1920 des product.product
        ...
        if count:
            self.variant_images_configured = True
        msg = _("%d image(s) assignée(s)") % count
