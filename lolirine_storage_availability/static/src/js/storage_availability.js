/**
 * Lolirine Storage Availability v3.4
...
(function () {
    ...
    if (!url.includes('/shop/')) {
        // Ne pas exécuter le reste du script
        console.log('Lolirine Storage: Page hors /shop/, script ignoré');
    } else {
        // Tout le code est dans ce bloc
        console.log('=== Lolirine Storage v3.4: Script chargé sur page shop ===');
