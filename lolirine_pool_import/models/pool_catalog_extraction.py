...
class PoolCatalogExtractionProduct(models.Model):
    ...
    def action_import_to_odoo(self):
        ...
        vals = {
            'name': self.name,
            'default_code': f"POOL-{self.reference or self.type_code or self.id}",
            'x_pool_supplier_ref': self.reference or self.type_code,
            ...
            # Spécifications techniques
            'x_power_kw': self.power_kw or 0,
            'x_power_cv': self.power_cv or '',
            'x_voltage': self.voltage or 0,
            'x_flow_rate': self.flow_rate or 0,
            'x_diameter_mm': self.diameter_mm or 0,
            'x_filter_area': self.filter_area or 0,
            'x_cop': self.cop or 0,
            'x_noise_level': self.noise_level or 0,
        }
