...
class PoolCategoriesController(http.Controller):
    ...
    def page_traitement_eau(self, **kwargs):
        ...
        # Image hero: utiliser l'image de la catégorie parent si disponible
        hero_image = None
        if parent and parent.image_1920:
            hero_image = f'/web/image/product.public.category/{parent.id}/image_1920'
        
        values = {
            'universe_name': 'Traitement de l\'eau',
            'universe_description': 'Tous les produits pour maintenir une eau saine, claire et parfaitement équilibrée.',
            'universe_icon': 'fa-tint',
            'universe_color': 'cyan',
            'hero_class': 'pshop-hero-cyan',
            'hero_image': hero_image,
            'parent_category': parent,
            'parent_url': self._get_category_url(parent),
            'subcategories': subcategories,
        }
        return request.render('lolirine_pool_categories.page_univers_dynamic', values)
    ...
    def page_nettoyage(self, **kwargs):
        ...
        values = {
            ...
            'universe_description': 'Robots automatiques, aspirateurs et accessoires pour une piscine impeccable sans effort.',
            'universe_icon': 'fa-robot',
            'universe_color': 'gray',
            'hero_class': 'pshop-hero-gray',
            'hero_image': hero_image,
            'parent_category': parent,
            'parent_url': self._get_category_url(parent),
            'subcategories': subcategories,
    ...
    def page_wellness(self, **kwargs):
        ...
        values = {
            ...
            'universe_description': 'Spas, jacuzzis, saunas et accessoires pour créer votre espace bien-être à domicile.',
            'universe_icon': 'fa-hot-tub',
            'universe_color': 'orange',
            'hero_class': 'pshop-hero-orange',
            'hero_image': hero_image,
            'parent_category': parent,
            'parent_url': self._get_category_url(parent),
            'subcategories': subcategories,
    ...
    def page_equipements(self, **kwargs):
        ...
        values = {
            ...
            'universe_description': 'Pompes, filtres, chauffage, éclairage et toutes les pièces détachées pour votre installation.',
            'universe_icon': 'fa-cogs',
            'universe_color': 'teal',
            'hero_class': 'pshop-hero-teal',
            'hero_image': hero_image,
            'parent_category': parent,
            'parent_url': self._get_category_url(parent),
            'subcategories': subcategories,
