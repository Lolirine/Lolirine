...
(function() {
    ...
    Chat.prototype._scheduleTeaser = function() {
        var self = this;
        // Only show teaser once per session
        if (sessionStorage.getItem("lai_teaser_shown")) return;
    ...
    Chat.prototype._showTeaser = function() {
        ...
        sessionStorage.setItem("lai_teaser_shown", "1");
        ...
        teaser.innerHTML =
            ...
            'Je peux vous aider \u00e0 trouver ce qu\u2019il vous faut.';
