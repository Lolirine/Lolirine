{
    ...
    'summary': 'Import de produits Fluidra avec OCR IA, variantes, attributs informatifs et extraction d\'image',
    'description': """
        ...
        - **NOUVEAU** Attributs informatifs (non-variants) pour le site web:
          * Gaz réfrigérant (R290, R32, R410A)
          * Alimentation électrique
          * Volume piscine conseillé
          * Température de fonctionnement
          * Connexion eau, classe énergétique, technologie...
        - **NOUVEAU** Extraction automatique de l'image produit depuis le catalogue
