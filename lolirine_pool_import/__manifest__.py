{
    ...
    'description': """
        ...
        - Recherche d'images Google Custom Search:
        ...
        **NOUVEAU v3.2.0:**
        - Publication automatique sur le site e-commerce Pool Store
        - Assignation automatique au website Pool Store
        - Mapping intelligent vers les catégories e-commerce publiques
        - Les produits apparaissent directement dans la boutique en ligne
        
        **NOUVEAU v3.3.0:**
        - Description formatée HTML pour le site web (website_description)
        - Tableau des spécifications techniques automatique sur la fiche produit
        - Toutes les specs (puissance, débit, COP, etc.) ajoutées comme attributs
