...
(function() {
    ...
    function initializeStoragePlan() {
        ...
        $(document).on('click', '#btn-appointment, #btn-reserve', function() {
            // Attendre un court instant pour laisser le lien s'ouvrir
            setTimeout(function() {
                $('#boxDetailsModal').modal('hide');
            }, 300);
        });

        // Gestionnaire explicite pour le bouton de fermeture
