...
class ScraperOrchestrator:
    ...
    def find_images(self, product, max_results=5):
        ...
        all_results = []
        seen_hashes = set()  # déduplication grossière par URL

        for scraper in self._get_scrapers():
        ...
        return all_results[:max_results * 2]  # on en garde plus pour la dédup phash
