...
(function() {
    ...
    $(document).ready(function() {
        console.log('Storage Plan JS loaded v1.0.42');
    ...
    function initializeStoragePlan() {
        ...
        function displayBoxDetails(boxData) {
            ...
            // Badge du statut avec couleur dynamique
            ...
            // Appliquer la couleur de statut directement
            if (boxData.status_color) {
                $statusBadge.css({
                    'background-color': boxData.status_color,
                    'color': '#fff',
                    'font-size': '18px',
                    'padding': '10px 20px',
                    'font-weight': 'bold',
