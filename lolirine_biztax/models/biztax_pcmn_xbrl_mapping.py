...
class BiztaxPcmnXbrlMapping(models.Model):
    ...
    fiscal_category = fields.Selection([
        ...
        ('dna_interest_thin_cap', 'DNA - Intérêts thin cap/ATAD'),
        ('dna_tax', 'DNA - Impôts non déductibles'),
        ('dna_isoc', 'DNA - ISOC et impôts similaires'),
        ...
        # Exonérations
        ('exempt_subsidy', 'Exonération - Subsides en capital'),
        # Autres
        ('other', 'Autre'),
